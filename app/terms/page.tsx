...
export const metadata = {
  title: "Terms of Service | AM Agency",
  description: "Terms of Service governing use of AM Agency platform services and client engagements.",
};
    ...
    >
      <section className="legal-section-card">
        ...
        <p className="legal-section-body">
          AM Agency agrees to provide design, engineering, and software delivery services as defined in individual client Statements of Work (SOW) or project briefs. All deliverables are built around agreed scope boundaries.
        </p>
      </section>
      ...
      <section className="legal-section-card">
        ...
        <p className="legal-section-body">
          AM Agency operates under transparent scope principles. No undisclosed recurring commitments, sub-licensing obligations, or external dependencies are introduced without explicit client approval.
        </p>
      </section>
      ...
      <section className="legal-section-card">
        ...
        <div className="legal-contact-box">
          <p><strong>AM Agency Head Office</strong></p>
